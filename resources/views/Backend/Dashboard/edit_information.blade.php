                                          ...
                                          <div class="row">
                                              <div class="col-6">
                                                <div class="form-group">
                                                  ...
                                                  <input type="number" onkeypress="return /[0-9]/i.test(event.key)" class="form-control" id="salary" name="salary"  placeholder="Enter Salary" value="{{ $edit_information->salary}}">
                                                </div>
                                              </div>
                                              <div class="col-6">
                                                <div class="form-group">
